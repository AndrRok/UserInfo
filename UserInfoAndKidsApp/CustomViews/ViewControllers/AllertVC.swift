...
class AllertVC: UIViewController {
    ...
    let titleLabel   = Label(textAlignment: .center, fontSize: 20)//
    let messageLabel = Label(textAlignment: .center, fontSize: 20)//
    let actionButton = Button(backgroundcolor: .systemPink, title: "Ok", fontSize: 12)
